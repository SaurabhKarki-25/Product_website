...
export default function Login() {
  ...
  const handleLogin = (e) => {
    ...
    if (form.email === user.email && correct) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#020d14] relative overflow-hidden">
      ...
      {/* --- Animated glow balls background --- */}
      ...
      ">
        ...
        {/* Title */}
        <h1 className="text-4xl font-bold text-cyan-400 mb-8 text-center tracking-wide drop-shadow-[0_0_10px_cyan]">
          Welcome Back
        </h1>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          {/* LOGIN BUTTON with Shine Animation */}
          <button
            type="submit"
            className="
